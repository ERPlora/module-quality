...
@login_required
@htmx_view('quality/pages/inspection_add.html', 'quality/partials/inspection_add_content.html')
def inspection_add(request):
    ...
    if request.method == 'POST':
        ...
        response['HX-Redirect'] = reverse('quality:inspections_list')
        return response
    return {}

@login_required
@htmx_view('quality/pages/inspection_edit.html', 'quality/partials/inspection_edit_content.html')
...
@login_required
@permission_required('quality.manage_settings')
